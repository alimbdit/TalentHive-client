...
const Header = () => {
  ...
  return (
    <div className="bg-accent bg-opacity-5 z-50">
      <div className="px-4 py-5 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 ">
        <nav className="relative flex items-center justify-between">
          ...
          >
            <div className="flex items-center justify-center w-14 h-14 rounded-full bg-primary bg-opacity-10">
              <AcademicCapIcon className="h-10 w-10 text-accent" />
            </div>
            <span className="text-error ml-3 text-4xl font-black tracking-wide ">
                  ...
                  <div className="flex items-center justify-between mb-4">
                    <div>
                      ...
                      >
                        ...
                        <span className="ml-2 text-2xl font-black tracking-wide text-error uppercase">
                          T<span className="text-primary">H</span>
                        </span>
                      </Link>
                    </div>
                    <div>
